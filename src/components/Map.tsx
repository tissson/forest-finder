    ...
    map.addLayer({
      ...
      paint: {
        ...
        "heatmap-color": [
          ...
          ["heatmap-density"],
          0, "rgba(0, 0, 0, 0)",
          0.08, "rgba(59, 130, 246, 0.12)",
          0.2, "rgba(34, 197, 94, 0.38)",
          0.4, "rgba(16, 185, 129, 0.62)",
          0.58, "rgba(234, 179, 8, 0.72)",
          0.74, "rgba(249, 115, 22, 0.82)",
          0.86, "rgba(236, 72, 153, 0.88)",
          1, "rgba(147, 51, 234, 0.94)",
        ],
        "heatmap-radius": [
          "interpolate",
          ["linear"],
